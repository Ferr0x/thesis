...
[*] '/home/ferro/Downloads/terminator'
    ...
    The next bug that I will show, as can be understood from the name, concerns another section of memory such as the heap which functions differently than the stack.\newline
