...
[*] '/home/ferro/Downloads/terminator'
    ...
    But we have an arbitrary writing source, in fact we can overwrite the size of the top chunk making it giant until we reach the entry we want to overwrite
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.7\linewidth]{heap_arb_write.jpg}
        \caption{Enter Caption}
        \label{fig:enter-label}
    \end{figure}
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=1\linewidth]{heap_after_arb_write.jpg}
        \caption{Enter Caption}
        \label{fig:enter-label}
    \end{figure}
